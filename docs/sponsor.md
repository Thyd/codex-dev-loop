# Sponsor Codex Dev Loop / 赞助 Codex Dev Loop
...
这是一个非官方 Codex 社区 skill。赞助会用于维护 loop harness、示例、文档，以及与 GitHub Actions、Semgrep、CodeQL、Sonar、Qodana、Qodo PR-Agent、CodeRabbit 等质量工具的兼容性更新。
...
This is an unofficial community skill for Codex. Sponsorship helps maintain the loop harness, examples, documentation, and compatibility with quality tools such as GitHub Actions, Semgrep, CodeQL, Sonar, Qodana, Qodo PR-Agent, and CodeRabbit.

### WeChat Pay

Scan the QR code below with WeChat Pay:
